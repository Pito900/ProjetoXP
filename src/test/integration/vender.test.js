...
describe(('Testando o POST /investimentos/vender.'), () => {
    describe(('Quando o usuário não preenche todos os campos do cadastro.'), () => {
        ...
        it('Deve retornar uma mensagem: "codAtivo" is required', async () => {
            expect(response.body.message).to.have.equal('"codAtivo" is required')
        });
    });
});